...
export async function sendOrderConfirmationEmail(order) {
  try {
    // TODO: Replace these with your actual email addresses and domain
    const FROM_EMAIL = process.env.NEXT_PUBLIC_FROM_EMAIL || 'orders@nerdbillyfab.com'
    const SUPPORT_EMAIL = process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@nerdbillyfab.com'
    const DOMAIN = process.env.NEXT_PUBLIC_DOMAIN || 'https://nerdbillyfab.com'
    ...
    const mailData = {
      ...
      template: {
        ...
        data: {
          ...
          trackOrderUrl: `${DOMAIN}/track-order`,
        },
      },
      message: {
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${DOMAIN}/track-order" style="display: inline-block; background-color: #dc2626; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 6px; font-weight: bold; font-size: 16px;">
                  Track Your Order
                </a>
              </div>
          ...
          <tr>
            <td style="background-color: #1a1a1a; padding: 30px; text-align: center; border-top: 1px solid #404040;">
              <p style="color: #737373; font-size: 14px; margin: 0 0 10px 0;">
                Questions? Contact us at <a href="mailto:${SUPPORT_EMAIL}" style="color: #dc2626; text-decoration: none;">${SUPPORT_EMAIL}</a>
              </p>
...
Track your order: ${DOMAIN}/track-order
